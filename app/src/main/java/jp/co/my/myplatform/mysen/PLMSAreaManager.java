...
import jp.co.my.myplatform.mysen.land.PLMSColorCover;
import jp.co.my.myplatform.mysen.land.PLMSLandRoute;
import jp.co.my.myplatform.mysen.land.PLMSRouteArray;
import jp.co.my.myplatform.mysen.land.PLMSRouteCover;
import jp.co.my.myplatform.mysen.unit.PLMSSkillData;

import static jp.co.my.myplatform.mysen.PLMSFieldView.MAX_X;
import static jp.co.my.myplatform.mysen.PLMSFieldView.MAX_Y;
import static jp.co.my.myplatform.mysen.PLMSFieldView.MIN_XY;
